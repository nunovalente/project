        ...
        <div class="box-inner">
            ...
            <div class="box-content row">
                <div class="col-lg-12 col-md-12">
                    @if(isset($approved_projects) && count($approved_projects) > 0)
                        <p class="alert alert-info">Approved Projects</p>
                        ...
                        @endforeach
                    @else
                        <p class="alert alert-success">There are 0 approved projects :(</p>
                    @endif
                    </table>
                </div>
            </div>
            ...
            <div class="box-content row">
                <div class="col-lg-12 col-md-12">
                    @if(isset($approved_media) && count($approved_media) > 0)
                        <p class="alert alert-warning">Approved Media</p>
                        <table class="list-group full-width">
                        @foreach ($approved_media as $media)
                            <tr class="list-group-item">
                        ...
                        @endforeach
                    @else
                        <p class="alert alert-success">There are 0 approved media :(</p>
                    @endif
                    </table>
                </div>
            </div>
            ...
            <div class="box-content row">
                <div class="col-lg-12 col-md-12">
                    @if(isset($approved_comments) && count($approved_comments) > 0)
                        <p class="alert alert-danger">Approved Comments</p>
                        <table class="list-group full-width">
                        ...
                        @endforeach
                    @else
                        <p class="alert alert-success">There are 0 approved comments :(</p>
                    @endif
                    </table>
                </div>
            </div>
